...
Plugin 'scrooloose/nerdtree' "tree dir
Plugin 'jistr/vim-nerdtree-tabs' "tree tab
Plugin 'kien/ctrlp.vim' "find file by ctrl + p
...
" ctrl + tab doesn't send by terminal
"map <S-C-tab> :MBEbp<CR>
"map <C-tab> :MBEbn<CR>
map <F9> :MBEbp<CR>
map <F10> :MBEbn<CR>
